package per.wxp.serve.sys.utils;
...
public class SysRedisTokenStore implements TokenStore {
    ...
    public SysRedisTokenStore(RedisConnectionFactory connectionFactory) {
